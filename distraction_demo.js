...
let expName = 'distraction_demo';  // from the Builder filename that created this script
let expInfo = {
...
function distraction_loopLoopBegin(distraction_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisDistraction_loop of distraction_loop) {
