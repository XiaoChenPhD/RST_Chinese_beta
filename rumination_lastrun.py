...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/Chenxiao/Documents/project_codes/RST_Chinese_beta/rumination_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisRumination_loop in rumination_loop:
        ...
        if isinstance(rumination_loop, data.TrialHandler2) and thisRumination_loop.thisN != rumination_loop.thisTrial.thisN:
            continueRoutine = False
